...
public class frame extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        MongoDatabase database2 = Enrollment.connectToDatabase();
        List<Enrollment> roll = Enrollment.getAllEnrollmentFromDB(database2);
        
        for(Enrollment enro : roll){
            if(code.equals(enro.getSubjectCode())){
                JOptionPane.showMessageDialog(this, 
                    "A Student is enrolled in " + desc + " (" + code + ")", 
